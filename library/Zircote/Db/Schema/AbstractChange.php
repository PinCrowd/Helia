 ...
 *
 */
abstract class Zircote_Db_Schema_AbstractChange
{
    /**
     *
     * @var integer
     ...
     *
     * @param string $dir
     * @return Zircote_Db_Schema_AbstractChange
     */
    ...
    /**
     *
     * @throws Zircote_Db_Schema_Exception
     */
    protected function _processDataXml()
    {
        ...
        if($dataFile){
            ...
            if(!$data){
                ...
                throw new Zircote_Db_Schema_Exception($errors);
            }
