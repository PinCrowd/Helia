...
abstract class Zircote_Rest_AbstractController extends Zend_Controller_Action
{
     ...
     *
     * @var Zircote_Model_AbstractModel|Zircote_Model_AbstractModelCollection
     */
...
//         $this->_purgeCache();
    ...
    /**
     *
     * @param Zircote_Rest_AbstractService $service
     * @return Zircote_Rest_AbstractController
     */
    ...
    /**
     *
     * @see Zircote_Rest_AbstractController::headAction()
     */
    ...
    protected function _getResultFormatted()
    {
         ...
         */
        if($this->_lastResponse instanceof Zircote_Rest_IsLoadableInterface && !$this->_lastResponse->isLoaded()){
...
//         $this->_saveEtag($result);
    ...
    /**
     *
     * @return Zircote_Rest_Cache_Page
     */
    ...
    /**
     *
     * @param Zircote_Rest_Cache_Page $cache
     * @return Zircote_Rest_AbstractController
     */
    public function setCache(Zircote_Rest_Cache_Page $cache)
    {
        $this->_cache = $cache;
        return $this;
    }
    ...
    protected function _setUpCache()
    {
        ...
        (($cache = $bootstrap->getResource('cachemanager')
         ->getCache('page_cache'))  instanceof Zircote_Rest_Cache_Page)){
            $this->setCache($cache);
            if($this->_resource){
