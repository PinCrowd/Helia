 ...
 * @subpackage Cache
 */
class Zircote_Rest_Cache_Page extends Zend_Cache_Core
{
    ...
    public function start($id = false, $tags = null, $doNotDie = false)
    {
        ...
        if ($etag = $this->getRequest()->getHeader('if-none-match')) {
            if($this->_backend->getIdsMatchingTags(array('__etag__' . $etag))){
                ...
                if (!$doNotDie && !$this->_specificOptions['default_options']['dnd'] &&
                    !defined('Zircote_PHPUNIT_TEST_ACTIVE')) {
                    die();
                } else {
                    return;
                }
        ...
        if ($array !== false) {
            ...
            if (!$doNotDie && !$this->_specificOptions['default_options']['dnd'] && !defined('Zircote_PHPUNIT_TEST_ACTIVE')) {
                die();
            }
            return true;
        }
