 ...
 * @subpackage Zircote_Cache_Backend
 */
 ...
 * @subpackage Zircote_Cache_Backend
 */
class Zircote_Cache_Backend_MongoDb extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    /**
     ...
     * @return Zircote_Cache_Backend_MongoDb
     */
    ...
    private function _registerTag($id, $tag) {
        ...
        if (!$res) {
            $this->_log(
                "Zircote_Cache_Backend_MongoDb::_registerTag() : ".
