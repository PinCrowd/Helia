...
require_once 'Zircote/Cache/Backend/MongoDb.php';
 ...
 * @group      Zend_Cache
 */
class Zircote_Cache_MongodbBackendTest extends PHPUnit_Framework_TestCase {
    ...
    public function __construct($name = null, array $data = array(), $dataName = '')
    {
        ...
        $this->_className = 'Zircote_Cache_Backend_MongoDb';
        $this->_root = __DIR__;
    ...
    {
        $this->_instance = new Zircote_Cache_Backend_MongoDb(
    ...
    {
        $test = new Zircote_Cache_Backend_MongoDb(
            array('database_name' => 'zend_cache',
            'collection' => 'cache')
        );
    }
