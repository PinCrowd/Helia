 ...
 * @package Zircote_Rest
 * @subpackage UnitTests
 * @group Zircote_Rest_Cache_PageTest
 */
class Zircote_Rest_Cache_PageTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->object = new Zircote_Rest_Cache_Page(array(
            'cache' => true,
        ...
        $this->object->setBackend(
            new Zircote_Cache_Backend_MongoDb(
    ...
    /**
     * @covers Zircote_Rest_Cache_Page::start
