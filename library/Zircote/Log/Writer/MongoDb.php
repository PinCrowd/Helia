 ...
 * @category   Zircote
 * @package    Zircote_Log
 * @subpackage Zircote_Log_Writer
 */
/**
 * @see Zircote_Log_Writer_Abstract
 */
 ...
 *         'filterName' => 'Priority',
 *         'filterParams' => array('priority' => Zircote_Log::WARN)),
 *         array('writerName' => 'Firebug', 'filterName' => 'Priority',
 *             'filterParams' => array('priority' => Zircote_Log::INFO))
 *     )
 * );
 ...
 * );
 * $log = new Zend_log();
 * $log->addWriter(Zircote_Log_Writer_MongoDb::factory($config));
 ...
 *
 * <code>
 * $config = array('collection' => 'log','database' => 'ibp');
 * $writer = Zircote_Log_Writer_MongoDb::factory($config);
 * $log = new Zend_log();
 ...
 * $log = new Zend_log();
 * $writer = new Zircote_Log_Writer_MongoDb($collection);
 * $log->addWriter($writer);
 * $log->err(__METHOD__);
 * </code>
 *
 ...
 * resources.log.mongo.defaultNamespace = "Zircote_Log_Writer"
 * resources.log.mongo.writerParams.database = "ibp"
 ...
 *
 */
class Zircote_Log_Writer_MongoDb extends Zend_Log_Writer_Abstract
{
    /**
     *
     *
    ...
    /**
     * (non-PHPdoc)
     * @see Zircote_Log_Writer_Abstract::_write()
     */
